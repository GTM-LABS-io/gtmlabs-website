...
export function ContainerTextFlip({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative inline-block pt-2 pb-3 text-center text-4xl font-bold",
        // Only apply default styles if no custom className is provided
        !className && "rounded-lg text-black md:text-7xl dark:text-white [background:linear-gradient(to_bottom,#f3f4f6,#e5e7eb)] shadow-[inset_0_-1px_#d1d5db,inset_0_0_0_1px_#d1d5db,_0_4px_8px_#d1d5db] dark:[background:linear-gradient(to_bottom,#374151,#1f2937)] dark:shadow-[inset_0_-1px_#10171e,inset_0_0_0_1px_hsla(205,89%,46%,.24),_0_4px_8px_#00000052]",
        className
      )}
